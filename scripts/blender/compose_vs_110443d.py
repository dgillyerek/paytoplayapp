#!/usr/bin/env python3
"""Side-by-side 110443d FAIL MP4 frames vs this cycle-closed hang-arm iterate."""
...
def main() -> None:
    ...
    frames = [(0, "n=0 pass L"), (5, "n=5"), (10, "n=10 mid-swing"), (15, "n=15")]
    cells = []
    ...
    out = PROOF / "gate3_path2_vs_110443d.png"
    sheet.save(out, optimize=True)
    (ART / out.name).write_bytes(out.read_bytes())
    print("vs-110443d", out, out.stat().st_size)
