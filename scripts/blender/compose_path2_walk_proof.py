...
def main() -> None:
    ...
    caps = {
        "pass_l": "PASS L  |  Meshy hang-arm  |  bind NOT claimed",
    ...
    d.text((24, 18), "GATE 3  |  PATH 2 Meshy hang-arm  |  vs fd9d6f8 BIND FAIL  |  bind NOT claimed", fill=(236, 230, 210), font=f_lg)
    d.text(
        (24, 56),
