...
**Motion bind:** Meshy GLB / `e5b132f` UVs kept (LOOK PASS `fd9d6f8`). Isolated hang-arm solidify + full leg tubes after fd9 BIND FAIL. No remesh/capsule Game-view. `Evaluate()` `5916447` reused. **Bind NOT claimed.**
