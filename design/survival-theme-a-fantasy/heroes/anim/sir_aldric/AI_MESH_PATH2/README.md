...
Skin (escalation remesh+FBX): `blender --background --python scripts/blender/skin_sir_aldric_retopo.py`  
Census: `blender --background --python scripts/blender/census_path2_bind.py`

**Look PASS** on `e5b132f`. Walk FAIL on `89481e5` / `71f0c4a` / `e56aeb1`. Shatter weights abandoned. **Walk-with-look NOT claimed.** Play hub PNG stays locked.
