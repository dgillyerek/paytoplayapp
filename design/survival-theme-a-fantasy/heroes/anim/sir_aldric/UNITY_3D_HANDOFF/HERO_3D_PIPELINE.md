...
Gate 2 blockout (grey clay vs locked helmeted turnaround; portrait = face law) is in `Docs/Survival/previews/blockout/`. Texture / walk / Play hub stay paused. **Gate 2 not claimed.**
