...
- **Motion now:** 4 Game-view keys (`pass L / contact L / pass R / contact R`) solved against `WALK_GAIT_BAR` rear phases on this hang −Y rig. Pass thigh is slightly **+X** so 70° knee lifts the foot ~25 cm. Contralateral pendulum ±30° X, hip drop `Hips.Z=±12`, spine yaw opposite the pelvis, heel→toe foot X. Attack clip unchanged. March +Z = TOP, 0.80 m/s.
